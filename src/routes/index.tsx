...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "ToolzHub — Supercharge Your Social Media Growth" },
      { name: "description", content: "Premium SMM panel services, log upgrades, and digital marketing tools. Trusted by 15,000+ resellers worldwide." },
    ],
  }),
  component: Landing,
});
...
function BlogPreview() {
  ...
  return (
    <section className="mx-auto max-w-7xl px-6 py-20">
      ...
      <div className="grid md:grid-cols-3 gap-5">
        {posts.map((p) => (
          <Link key={p.slug} to="/blog/$slug" params={{ slug: p.slug }} className="group rounded-2xl border border-border bg-card overflow-hidden hover:border-primary/40 transition-colors">
